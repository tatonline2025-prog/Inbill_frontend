    ...
    <ProtectedRoute fallback={<p>Redirecting...</p>}>
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-2xl font-bold text-blue-700 mb-6">Quản lý Xã/Phường &amp; Prefix mã hóa đơn</h1>
          ...
          <div className="bg-white rounded-xl shadow p-5 mb-6">
            ...
            <div className="flex flex-wrap gap-3 items-end">
              ...
              <button
                className="bg-blue-600 text-white font-bold px-5 py-2 rounded-lg hover:bg-blue-700 disabled:opacity-50 whitespace-nowrap"
                onClick={handleAdd}
                disabled={isAdding}
              >
                + Thêm
